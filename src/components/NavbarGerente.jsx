  ...
  return(
      ...
      <nav className=" w-screen h-auto border-b border-slate-700 text-lg bg-slate-900">
        <ul className="flex flex-row mx-32">
          ...
          <li className=" flex w-32 h-11"><Link to='/paginaweb-administrativa' className="w-full h-full hover:bg-gray-400 flex justify-center items-center">Cerrar Sesión</Link></li>
        </ul>
      </nav>
